...
POSE_GRAPH.constraint_builder.min_score_with_map = 0.7
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.7
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 5e5
POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 2e6
--与全局地图匹配权重
