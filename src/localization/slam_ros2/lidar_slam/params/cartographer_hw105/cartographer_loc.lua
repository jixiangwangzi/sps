...
POSE_GRAPH.constraint_builder.min_score_with_map = 0.52
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.4
POSE_GRAPH.constraint_builder.loop_closure_translation_weight = 1.1e0
POSE_GRAPH.constraint_builder.loop_closure_rotation_weight = 1e0
