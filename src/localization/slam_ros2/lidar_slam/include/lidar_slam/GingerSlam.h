...
//  * Created Date: Wednesday, October 25th 2020, 11:11:08 am
//  * Author: Chen Hao (hao.chen@cloudminds.com)
//  * -----
//  * Last Modified: Thu Aug 13 2020
...
// {
// public:
//     // GingerSlam(RosNodeHandlePtr &nh, RosTf2BufferPtr &buffer, RosTf2BroadPtr &cast)
...
//     //     scan_filter_->registerCallback(&GingerSlam::laserCallback, this);
//     //     loc_confidence_pub_ = nh_->create_publisher<std_msgs::msg::Float32>("/loc_confidence", 10);
//     //     mapping_data_pub_ = nh_->create_publisher<nav_msgs::msg::OccupancyGrid>("/update_occmap", 1, true);
//     //     // location_state_pub_ = nh_->advertise<ginger_msgs::LocationState>("/location_state", 1, true);
//     //     //TODO:
//     //     robot_pose_pub_ = nh_->create_publisher<geometry_msgs::msg::PoseWithCovarianceStamped>("hd_map_init_pose", 1, true);
//     // }
// //     GingerSlam(RosNodeHandlePtr &nh, RosTf2BufferPtr &buffer, RosTf2BroadPtr &cast, int map_model)
// //             : nh_(nh), tf2_buffer_(buffer), tf2_cast_(cast)
// //     {
// //         if (map_model != 2)
// //         {
// //             scan_sub_ = std::make_shared<MessageFilterSub>(*nh_, "/scan", 10);
...
// //             scan_filter_->registerCallback(&GingerSlam::laserCallback, this);
// //         }
// //         loc_confidence_pub_ = nh_->advertise<std_msgs::Float32>("/loc_confidence", 10);
// //         mapping_data_pub_ = nh_->advertise<nav_msgs::OccupancyGrid>("/update_occmap", 1, true);
// //         rdm_pub_ = nh_->advertise<ginger_msgs::RdmAlarm>("/rdm_alarm", 1, true);
// //         location_state_pub_ = nh_->advertise<ginger_msgs::LocationState>("/location_state", 1, true);
// //         //TODO:
// //         robot_pose_pub_ = nh_->advertise<geometry_msgs::PoseWithCovarianceStamped>("hd_map_init_pose", 1, true);
// //     }
//     virtual ~GingerSlam() = default;
...
//         RCLCPP_ERROR(nh_->get_logger(),"GingerSlam: No set occ map");
//         return false;
//     };
//     virtual bool setInitialPose(const geometry_msgs::msg::PoseWithCovarianceStamped& msg) {
//         RCLCPP_ERROR(nh_->get_logger(),"GingerSlam: No initial pose");
//         return false;
//     };

//     virtual bool SetInitPoseSelf(const sps_common_msgs::msg::InitialSlamPose& initial_pose_msg){
//         RCLCPP_ERROR(nh_->get_logger(),"GingerSlam: No initial pose");
//         return false;       
//     }

//     virtual bool trigGlobalLocalization(const int& reloc_command) {
//         RCLCPP_ERROR(nh_->get_logger(),"GingerSlam: No global localization");
//         return false;
//     };
...
// //         {
// //             //TODO:
// //             geometry_msgs::TransformStamped tmp_m_b = tf2_buffer_->lookupTransform(
// //                                 "map", "base_link", now, ros::Duration(0.5));
// //             geometry_msgs::PoseWithCovarianceStamped robot_m_b;
...
// //         {
// //             RCLCPP_ERROR_THROTTLE(5.0, "GingerSlam: cannot get tf: %s\n", e.what());
// //         }
...
//         catch(tf2::TransformException e)
//         {
//             RCLCPP_ERROR_THROTTLE(nh_->get_logger(), *nh_->get_clock(), 5, "GingerSlam: cannot get tf: %s\n", e.what()); 
//         }
//         return robot_m_b;
//     };   
...
//     rclcpp::Publisher<nav_msgs::msg::OccupancyGrid> mapping_data_pub_;
//     rclcpp::Publisher<std_msgs::msg::Float32> loc_confidence_pub_;
//     // rclcpp::Publisher<> location_state_pub_;                                       //TODO::待吉祥定义好消息后补充
//     rclcpp::Publisher<geometry_msgs::msg::PoseWithCovarianceStamped> robot_pose_pub_;
...
//         rclcpp::Time transform_expiration = nh_->now();// + ros::Duration(0.1);
...
#endif //GINGER_NAVIGATION_GINGERSLAM_H
