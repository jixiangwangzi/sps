...
class ConstraintBuilderOptions : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:cartographer.mapping.constraints.proto.ConstraintBuilderOptions) */ {
 public:
  ...
  // optional double min_score_with_map = 17;
  void clear_min_score_with_map();
  static const int kMinScoreWithMapFieldNumber = 17;
  double min_score_with_map() const;
  void set_min_score_with_map(double value);

  // optional double min_score_with_map_no_match = 18;
  void clear_min_score_with_map_no_match();
  static const int kMinScoreWithMapNoMatchFieldNumber = 18;
  double min_score_with_map_no_match() const;
  void set_min_score_with_map_no_match(double value);

  // optional double min_score_init = 19;
  void clear_min_score_init();
  static const int kMinScoreInitFieldNumber = 19;
  double min_score_init() const;
  void set_min_score_init(double value);

  // optional double min_score_init_no_match = 20;
  void clear_min_score_init_no_match();
  static const int kMinScoreInitNoMatchFieldNumber = 20;
  double min_score_init_no_match() const;
  void set_min_score_init_no_match(double value);
  ...
  // optional double global_loop_closure_translation_weight = 15;
  void clear_global_loop_closure_translation_weight();
  static const int kGlobalLoopClosureTranslationWeightFieldNumber = 15;
  double global_loop_closure_translation_weight() const;
  void set_global_loop_closure_translation_weight(double value);

  // optional double global_loop_closure_rotation_weight = 16;
  void clear_global_loop_closure_rotation_weight();
  static const int kGlobalLoopClosureRotationWeightFieldNumber = 16;
  double global_loop_closure_rotation_weight() const;
  void set_global_loop_closure_rotation_weight(double value);
 ...
 private:
  ...
  double min_score_;
  double min_score_with_map_;
  double min_score_with_map_no_match_;
  double min_score_init_;
  double min_score_init_no_match_;
  double global_localization_min_score_;
  double loop_closure_translation_weight_;
  double loop_closure_rotation_weight_;
  double global_loop_closure_translation_weight_;
  double global_loop_closure_rotation_weight_;
...
// optional double min_score_with_map = 17;
inline void ConstraintBuilderOptions::clear_min_score_with_map() {
  min_score_with_map_ = 0;
}
inline double ConstraintBuilderOptions::min_score_with_map() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_with_map)
  return min_score_with_map_;
}
inline void ConstraintBuilderOptions::set_min_score_with_map(double value) {
  
  min_score_with_map_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_with_map)
}

// optional double min_score_with_map_no_match = 18;
inline void ConstraintBuilderOptions::clear_min_score_with_map_no_match() {
  min_score_with_map_no_match_ = 0;
}
inline double ConstraintBuilderOptions::min_score_with_map_no_match() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_with_map_no_match)
  return min_score_with_map_no_match_;
}
inline void ConstraintBuilderOptions::set_min_score_with_map_no_match(double value) {
  
  min_score_with_map_no_match_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_with_map_no_match)
}

// optional double min_score_init = 19;
inline void ConstraintBuilderOptions::clear_min_score_init() {
  min_score_init_ = 0;
}
inline double ConstraintBuilderOptions::min_score_init() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_init)
  return min_score_init_;
}
inline void ConstraintBuilderOptions::set_min_score_init(double value) {
  
  min_score_init_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_init)
}

// optional double min_score_init_no_match = 20;
inline void ConstraintBuilderOptions::clear_min_score_init_no_match() {
  min_score_init_no_match_ = 0;
}
inline double ConstraintBuilderOptions::min_score_init_no_match() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_init_no_match)
  return min_score_init_no_match_;
}
inline void ConstraintBuilderOptions::set_min_score_init_no_match(double value) {
  
  min_score_init_no_match_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.min_score_init_no_match)
}
...
// optional double global_loop_closure_translation_weight = 15;
inline void ConstraintBuilderOptions::clear_global_loop_closure_translation_weight() {
  global_loop_closure_translation_weight_ = 0;
}
inline double ConstraintBuilderOptions::global_loop_closure_translation_weight() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.global_loop_closure_translation_weight)
  return global_loop_closure_translation_weight_;
}
inline void ConstraintBuilderOptions::set_global_loop_closure_translation_weight(double value) {
  
  global_loop_closure_translation_weight_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.global_loop_closure_translation_weight)
}

// optional double global_loop_closure_rotation_weight = 16;
inline void ConstraintBuilderOptions::clear_global_loop_closure_rotation_weight() {
  global_loop_closure_rotation_weight_ = 0;
}
inline double ConstraintBuilderOptions::global_loop_closure_rotation_weight() const {
  // @@protoc_insertion_point(field_get:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.global_loop_closure_rotation_weight)
  return global_loop_closure_rotation_weight_;
}
inline void ConstraintBuilderOptions::set_global_loop_closure_rotation_weight(double value) {
  
  global_loop_closure_rotation_weight_ = value;
  // @@protoc_insertion_point(field_set:cartographer.mapping.constraints.proto.ConstraintBuilderOptions.global_loop_closure_rotation_weight)
}
