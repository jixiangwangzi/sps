...
constexpr char kScanMatchedPointCloudTopic[] = "/dedistorted_laser_point_cloud";
...
constexpr char kLandmarkPosesListTopic[] = "/tag_poses_list";
constexpr char kConstraintListTopic[] = "constraint_list";
constexpr char kVisualSlamPose[] = "/visual_relocalization_pose";
constexpr char kTagPose[] = "/robot_pose";
constexpr char kTagToRobot[] = "/tag_to_robot";
constexpr char kLineExtraction[] = "/line_segments";
