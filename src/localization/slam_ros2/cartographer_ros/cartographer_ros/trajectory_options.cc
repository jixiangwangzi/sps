...
TrajectoryOptions CreateTrajectoryOptions( ::cartographer::common::LuaParameterDictionary* const lua_parameter_dictionary) 
{
  ...
  options.use_visual_slam_pose = lua_parameter_dictionary->GetBool("use_visual_slam_pose");
  options.use_tag_pose = lua_parameter_dictionary->GetBool("use_tag_pose");
  options.use_submap_match = lua_parameter_dictionary->GetBool("use_submap_match");
  options.submap_free_threshold = lua_parameter_dictionary->GetDouble("submap_free_threshold");
  ...
  options.use_confidence = lua_parameter_dictionary->GetBool("use_confidence");
  options.laserTh = lua_parameter_dictionary->GetDouble("laserTh");
  options.visualTh = lua_parameter_dictionary->GetDouble("visualTh");
  options.cancelTh = lua_parameter_dictionary->GetDouble("cancelTh");
