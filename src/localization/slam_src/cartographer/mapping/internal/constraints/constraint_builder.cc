...
proto::ConstraintBuilderOptions CreateConstraintBuilderOptions(
  ...
  options.set_min_score_with_map(parameter_dictionary->GetDouble("min_score_with_map"));
  options.set_min_score_with_map_no_match(parameter_dictionary->GetDouble("min_score_with_map_no_match"));
  options.set_min_score_init(parameter_dictionary->GetDouble("min_score_init"));
  options.set_min_score_init_no_match(parameter_dictionary->GetDouble("min_score_init_no_match"));
  ...
  options.set_global_loop_closure_translation_weight(
      parameter_dictionary->GetDouble("global_loop_closure_translation_weight"));
  options.set_global_loop_closure_rotation_weight(
      parameter_dictionary->GetDouble("global_loop_closure_rotation_weight"));
