...
class GlobalTrajectoryBuilder : public mapping::TrajectoryBuilderInterface {
 public:
  ...
  GlobalTrajectoryBuilder(
      ...
      : trajectory_id_(trajectory_id),
        ...
        scorePoseFromSubmapPtr_(local_trajectory_builder_->getScorePosePtr()),
        scorePoseFromMapPtr_(pose_graph_->getScorePoseFromMapPtr()) {}
  ...
  void AddSensorData(
    ...
    bool maybeLongCorridor = local_trajectory_builder_->getMaybeLongCorridor();
    ...
    if (matching_result->insertion_result != nullptr) {
      ...
      auto node_id = pose_graph_->AddNode(
          matching_result->insertion_result->constant_data, trajectory_id_,
          matching_result->insertion_result->insertion_submaps, maybeLongCorridor);
  ...
  std::shared_ptr<double> getScorePoseFromSubmapPtr() override { 
    if(scorePoseFromSubmapPtr_ == nullptr){
      LOG(ERROR) << "GlobalTrajectoryBuilder.scorePoseFromSubmapPtr_ is null"; 
    }
    return scorePoseFromSubmapPtr_;
  }
  std::shared_ptr<double> getScorePoseFromMapPtr() override { 
    if(scorePoseFromMapPtr_ == nullptr){
      LOG(ERROR) << "GlobalTrajectoryBuilder.scorePoseFromMapPtr_ is null"; 
    }
 ...
 private:
  ...
  std::shared_ptr<double> scorePoseFromSubmapPtr_;
