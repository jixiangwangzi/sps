...
class CollatedTrajectoryBuilder : public TrajectoryBuilderInterface {
 public:
  ...
  std::shared_ptr<double> getScorePoseFromSubmapPtr(){
    if(scorePoseFromSubmapPtr_ == nullptr){
      LOG(ERROR) << "CollatedTrajectoryBuilder.scorePoseFromSubmapPtr_ is null"; 
    }
    return scorePoseFromSubmapPtr_;
  }
  std::shared_ptr<double> getScorePoseFromMapPtr(){
    if(scorePoseFromMapPtr_ == nullptr){
      LOG(ERROR) << "CollatedTrajectoryBuilder.scorePoseFromMapPtr_ is null"; 
    }
