...
class LocalTrajectoryBuilder2D {
 public:
  ...
  bool getMaybeLongCorridor(){return maybeLongCorridor_;}
  std::shared_ptr<double> getScorePosePtr(){
      if(scorePosePtr_ == nullptr){
      LOG(ERROR) << "LocalTrajectoryBuilder2d.scorePosePtr_ is null"; 
      }
      return scorePosePtr_;
  }
 private:
  ...
  std::shared_ptr<double> scorePosePtr_;
