...
RealTimeCorrelativeScanMatcher2D::RealTimeCorrelativeScanMatcher2D(
    ...
    : options_(options),maybeLongCorridor_(false) {}
...
double RealTimeCorrelativeScanMatcher2D::Match(
  ...
  if(candidates[0].score - candidates[4].score < 0.05 && candidates[4].score > 0.5){
    // LOG(INFO) << "c0: " << candidates[0].score << " c[4]" << candidates[4].score << " diff:" << candidates[0].score - candidates[4].score;
    maybeLongCorridor_ = true;
  }
  else{
    maybeLongCorridor_ = false;
    // LOG(WARNING) << "~~~c: " << candidates[0].score << " c[4]" << candidates[4].score << " diff:" << candidates[0].score - candidates[4].score;
  }
