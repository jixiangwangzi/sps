...
CollatedTrajectoryBuilder::CollatedTrajectoryBuilder(
    ...
    : sensor_collator_(sensor_collator),
      ...
      scorePoseFromSubmapPtr_(wrapped_trajectory_builder_->getScorePoseFromSubmapPtr()),
      scorePoseFromMapPtr_(wrapped_trajectory_builder_->getScorePoseFromMapPtr()){

  LOG(INFO)<<"CollatedTrajectoryBuilder building!!!";
