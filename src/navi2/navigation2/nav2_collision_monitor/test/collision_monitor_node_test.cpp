...
static const char CMD_VEL_OUT_TOPIC_TWISTSTAMPED[]{"cmd_vel_out_twiststamped"};
...
protected:
  ...
  rclcpp::Subscription<geometry_msgs::msg::Twist>::SharedPtr cmd_vel_out_twiststamped_sub_;
...
Tester::Tester()
{
  ...
  cmd_vel_out_twiststamped_sub_ = cm_->create_subscription<geometry_msgs::msg::Twist>(
    CMD_VEL_OUT_TOPIC_TWISTSTAMPED, rclcpp::SystemDefaultsQoS(),
    std::bind(&Tester::cmdVelOutCallback, this, std::placeholders::_1));
}
...
Tester::~Tester()
{
  ...
  cmd_vel_out_twiststamped_sub_.reset();
...
void Tester::setCommonParameters()
{
  ...
  cm_->declare_parameter(
    "cmd_vel_out_topic_twiststamped", rclcpp::ParameterValue(CMD_VEL_OUT_TOPIC_TWISTSTAMPED));
  cm_->set_parameter(
    rclcpp::Parameter("cmd_vel_out_topic_twiststamped", CMD_VEL_OUT_TOPIC_TWISTSTAMPED));    
