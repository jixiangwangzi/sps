  ...
  std_msgs::msg::Header & footprint_header)
{
  ...
  footprint = nav2_costmap_2d::toPointVector(
  ...
  std_msgs::msg::Header & footprint_header)
{
  ...
  nav2_costmap_2d::transformFootprint(-x, -y, 0, footprint, temp);
  nav2_costmap_2d::transformFootprint(0, 0, -theta, temp, footprint);
