...
public:
  ...
  void updatePolygonStop(const Velocity & velocity,const double max_vel) override;
  void updatePolygonSlowdown(const Velocity & velocity,const double max_vel) override;
