...
#include "nav2_collision_monitor/footprint_subscriber.hpp"
...
public:
  ...
  virtual void updatePolygonStop(const Velocity & velocity,const double max_vel);
  virtual void updatePolygonSlowdown(const Velocity & velocity,const double max_vel);
  virtual void updatePolygonStopNew(const Velocity & velocity,const double max_vel);
  /**
...
protected:
  ...
  std::unique_ptr<FootprintSubscriber> footprint_sub_;
