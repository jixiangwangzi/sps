...
BT::NodeStatus IsPathValidCondition::tick()
{
    ...
    rclcpp::FutureReturnCode::SUCCESS)
  {
    if (result.get()->is_valid) {
      RCLCPP_INFO_THROTTLE(node_->get_logger(),*(node_->get_clock()),2000, "is path valid success");
      return BT::NodeStatus::SUCCESS;
    }
  }
  RCLCPP_INFO_THROTTLE(node_->get_logger(),*(node_->get_clock()), 2000, "is path valid faliure");
