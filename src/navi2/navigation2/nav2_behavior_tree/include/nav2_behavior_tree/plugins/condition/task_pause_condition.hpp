 ...
 */
class TaskPauseCondition : public BT::ConditionNode
{
public:
  /**
   * @brief A constructor for nav2_behavior_tree::TaskPauseCondition
  ...
  TaskPauseCondition() = delete;

  /**
   * @brief A destructor for nav2_behavior_tree::TaskPauseCondition
   */
  ~TaskPauseCondition() override;
...
private:    
  void pubTaksPauseState(const bool & state);
private:
  ...
  rclcpp::Publisher<std_msgs::msg::Bool>::SharedPtr task_pause_state_pub_;
