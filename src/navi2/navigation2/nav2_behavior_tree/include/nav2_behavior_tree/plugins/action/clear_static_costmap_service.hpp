...
#include "nav2_msgs/srv/clear_static_costmap.hpp"
 ...
 */
class ClearStaticCostmapService : public BT::ActionNodeBase
{
public:
  /**
   ...
   */
  ClearStaticCostmapService(
    const std::string & action_name,
    const BT::NodeConfiguration & conf);

//  ClearStaticCostmapService() = delete;
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::InputPort<double>("forward_dist", "distance to find point in global path"),
      BT::InputPort<double>("half_width", "half mark width"),
      BT::InputPort<std::chrono::milliseconds>("server_timeout"),
      BT::InputPort<bool>("mark", "half mark width"),
...
private:
  ...
  rclcpp::Client<nav2_msgs::srv::ClearStaticCostmap>::SharedPtr client_;
