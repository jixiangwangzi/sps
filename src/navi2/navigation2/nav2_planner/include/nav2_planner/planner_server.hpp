...
protected:
  ...
  /**
   * @brief The service callback to determine if the pose is safety
  ...
  // Service to deterime if the pose is safety
  rclcpp::Service<nav2_msgs::srv::IsPathValid>::SharedPtr is_path_valid_service_;
  rclcpp::Service<nav2_msgs::srv::IsPoseSafety>::SharedPtr is_pose_safety_service_; 
  rclcpp::Service<nav2_msgs::srv::ClearStaticCostmap>::SharedPtr clear_static_costmap_service_;
...
private:
  ...
  std::map<int, unsigned char>  origin_cost_;
