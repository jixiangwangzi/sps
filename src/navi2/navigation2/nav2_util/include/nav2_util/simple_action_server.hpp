...
public:
    ...
    server_timeout_(server_timeout)
  {
    ...
    action_server_cb_group_ = node_base_interface_->create_callback_group(rclcpp::CallbackGroupType::MutuallyExclusive, false);
    ...
    executor->add_callback_group(action_server_cb_group_, node_base_interface_);
    action_server_thread_ = std::make_unique<nav2_util::NodeThread>(executor);
  }
...
protected:
  ...
  std::unique_ptr<nav2_util::NodeThread> action_server_thread_;
