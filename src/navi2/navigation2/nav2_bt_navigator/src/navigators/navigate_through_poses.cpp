  ...
  rclcpp_lifecycle::LifecycleNode::WeakPtr parent_node)
{
  ...
  if (!node->has_parameter("default_nav_through_poses_bt_xml")) {
    ...
    node->declare_parameter<std::string>(
      ...
      pkg_share_dir +
      "/behavior_trees/navigate_through_poses_with_consistent_replanning_and_if_path_becomes_invalid.xml");
      //navigate_through_poses_w_replanning_and_recovery  navigate_through_poses_with_consistent_replanning_and_if_path_becomes_invalid
  }
