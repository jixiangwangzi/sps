...
#ifndef NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_LIFT_HPP_
#define NAV2_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_LIFT_HPP_
...
public:
  ...
  /**
   * @brief A constructor for NavigateToLiftNavigator
   */
  NavigateToLiftNavigator()
  : Navigator() {}
   ...
   */
  std::string getName() {return std::string("navigate_to_lift");}
...
protected:
  ...
  /**
   * @brief Receive navi type value callback
   * @param msg The navi type message
   */
