...
protected:
  ...
  // geometry_msgs::msg::PoseStamped getSampledPathPt(const double & path_len);
  geometry_msgs::msg::PoseStamped getSampledPathPt(const geometry_msgs::msg::PoseStamped & robot_pose);
  /**
