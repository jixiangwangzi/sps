...
protected:
  ...
  rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float32>::SharedPtr distance_remaining_pub_;
  rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PoseStamped>::SharedPtr end_pose_publisher_;
  ...
  double parking_dist_threshold_;
...
private:
  ...
  int          lift_access_state_;  // 0-nomal;1-drive in lift;3-drive out lift
};
